...
private final class MockCommonKeyManager: CommonKeyManager {
    ...
    func getNetworkPublicKeyByNetworkId(networkId _: String) async throws -> Data {
        networkPublicKey
    }

    func encryptWithEnvelope(data: Data, networkPublicKey _: Data?, profilePublicKeys _: [Data]) async throws -> Data {
    ...
    func ensureSymmetricKey(name: String) async throws -> Data {
        Data("mock-symmetric-key-\(name)".utf8)
    }
    ...
    func setPersistenceDirectory(_: String) async throws {
        // Mock implementation - do nothing
    }

    func enableAutoPersistence(_: Bool) async throws {
        // Mock implementation - do nothing
    }
    ...
    func registerAppleDeviceKeystore(label _: String) async throws {
        // Mock implementation - do nothing
    }

    func encryptForNetwork(data: Data, networkPublicKey _: Data) async throws -> Data {
        data
    }
...
private final class MockNodeTransport: NodeTransport {
    ...
    func connectToPeer(peerInfo _: SwiftFFI.PeerInfo) async throws {
        // Mock implementation - do nothing
    }

    func disconnectFromPeer(peerNodeId _: String) async throws {
        // Mock implementation - do nothing
    }

    func sendRequest(path _: String, payload _: Data, correlationId _: String) async throws {
        // Mock implementation - do nothing
    }

    func completeRequest(requestId _: String, responsePayload _: Data, profilePublicKey _: Data?) async throws {
        // Mock implementation - do nothing
    }

    func publish(topic _: String, payload _: Data, options _: PublishOptions) async throws {
        // Mock implementation - do nothing
    }

    func subscribe(topic _: String, subscriptionId _: String) async throws {
        // Mock implementation - do nothing
    }

    func unsubscribe(subscriptionId _: String) async throws {
        // Mock implementation - do nothing
    }
    ...
    func updateLocalNodeInfo(nodeInfo _: SwiftFFI.NodeInfo) async throws {
        // Mock implementation - do nothing
    }

    func request(path _: String, correlationId _: String, payload _: Data, peerNodeId _: String, networkPublicKey _: Data?, profilePublicKeys _: [Data]) async throws -> Data {
        // Simple mock implementation - return a mock response
        Data("mock-response".utf8)
    }
}
