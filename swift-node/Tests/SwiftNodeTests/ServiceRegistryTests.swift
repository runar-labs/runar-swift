...
final class ServiceRegistryTests: XCTestCase, @unchecked Sendable {
    ...
    private func createTestRegistry() -> ServiceRegistry {
        return ServiceRegistry(logger: createTestLogger())
    }
    ...
    func testMultipleActionHandlers() async throws {
        ...
        let subtractHandler: ActionHandler = { params, context in
            return AnyValue.primitive("subtract_result")
        }
    ...
    func testActionHandlerNetworkIsolation() async throws {
        ...
        let handler1: ActionHandler = { params, context in
            return AnyValue.primitive("network1_result")
        }
        
        let handler2: ActionHandler = { params, context in
    ...
    func testGetActionsMetadata() async throws {
        ...
        try await withTimeout(10.0) {
            ...
            let multiplyHandler: ActionHandler = { params, context in
                return AnyValue.null()
            }
            ...
            let actionPaths = actionsMetadata.map { $0.name }
    ...
    func testLocalRemoteActionHandlerSeparation() async throws {
        ...
        try await withTimeout(10.0) {
            ...
            let localHandler: ActionHandler = { params, context in
                return AnyValue.primitive("local_result")
            }
            try await registry.registerLocalActionHandler(
                topicPath: topicPath,
            ...
            let remoteHandler: ActionHandler = { params, context in
                return AnyValue.primitive("remote_result")
            }
