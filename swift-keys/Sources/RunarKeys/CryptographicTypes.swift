...
public enum KeyError: Error, LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .certificateChainError(let message):
            return "Certificate chain error: \(message)"
        case .secIdentityError(let message):
            return "SecIdentity error: \(message)"
        case .secTrustError(let message):
...
public struct ECDHKeyPair: Sendable {
    ...
    public init() throws {
        self.keyAgreementPrivateKey = P384.KeyAgreement.PrivateKey()
    ...
    public init(rawRepresentation: Data) throws {
        self.keyAgreementPrivateKey = try P384.KeyAgreement.PrivateKey(rawRepresentation: rawRepresentation)
        self.publicKey = keyAgreementPrivateKey.publicKey
    }
